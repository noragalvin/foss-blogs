...
<body class="">
  <div class="wrapper ">
    ...
    -->
      <div class="logo">
        <a href="/manage" class="simple-text logo-mini">
          <div class="logo-image-small">
            <img src="https://png.pngtree.com/svg/20170313/292fd6b79e.png">
          </div>
        </a>
        <a href="/manage" class="simple-text logo-normal">
          FOSS Blogs
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Admin Manager</a>
          </div>
